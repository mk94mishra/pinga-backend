...
#3 public endpoints
endpoint_public=[("GET",""),("GET","docs"),("GET","redoc"),("GET","openapi.json"),("POST","user/login-admin"),("POST","user/login-non-admin"),("POST","user/signup-normal"),("POST","user/login-non-admin-google"),("POST","user/signup-google"),("POST","user/create-password-reset-otp"),("POST","user/verify-password-reset-otp"),("POST","user/create-login-otp"),("POST","user/login-mobile-otp"),("GET","result/test"),("POST","extra/typeform"),("GET","mylocal")]
